...
const MultipleFileUploadNewEvent: React.FC<MultipleFileUploadNewEventProps> = ({
  ...
  const handlePriorityChange = (
    ...
    if (isNaN(updatedPriority) || updatedPriority < 0) {
      console.warn("Invalid or negative number input for priority");
    ...
    setImages((prevImages) => {
      ...
      newImages[index].priority = updatedPriority; // Update the priority
      onImagesChange(newImages); // Call the onImagesChange callback with the updated images
      return newImages;
    });
  };
        ...
        <div>
          ...
          <div className="grid grid-cols-12 gap-5">
            ...
            <div className="col-span-12 md:col-span-2">
              ...
              <input
                  type="number"
                  {...methods.register("image_priority")}
                  ...
                  {images.map((image: any, index: number) => (
                      <tr key={index} className="relative">
                        ...
                        <td className="text-center">
                          <input
                              type="number"
                              value={image.priority === null || image.priority === undefined ? "" : image.priority}
